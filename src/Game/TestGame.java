...
import OpenEngine.Components.DirectionalLight;
import OpenEngine.Components.FreeLook;
import OpenEngine.Components.FreeMove;
import OpenEngine.Components.MeshRenderer;
import OpenEngine.Components.PointLight;
import OpenEngine.Components.SpotLight;
...
public class TestGame extends Game
{
	public void Init()
	{
		...
		GameObject testMesh3 = new GameObject().AddComponent(new CameraController()).AddComponent(new MeshRenderer(tempMesh, material));
